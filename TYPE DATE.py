...
# Nama File : NO 1.py
# Deskripsi : Tipe bentukan penanggalan
# Tanngal   : 25 September 2024
...
# DEFINISI DAN SPESIFIKASI KONSTRAKTOR
...
print(Yesterday(MakeDate(1,1,2000))) # --> [31, 12, 1999]
print(Yesterday(MakeDate(1,1,2001))) # --> [31, 12, 2000]
print(NextDay(MakeDate(12,12,2000))) # --> [13, 12, 2000]
print(NextDay(MakeDate(31,12,2001))) # --> [1, 1, 2002]
print(isAfter(MakeDate(18,2,2000),MakeDate(18,3,2999))) # --> False
print(isBefore(MakeDate(3,11,2021),MakeDate(4,12,2024))) # --> True
print(isEq(MakeDate(12,3,2000),MakeDate(12,3,2000))) # --> True
print(isKabisat(2000)) # --> True
