...
bo1 = AddBooks([['Novel', ['Toko Kelontong Namiya', 'Bumi', 'The Little Prince']], ['Komputer', ['Clean Code', 'Modern OS', 'Computer Network', 'DSA', 'Algorithms']], ['Biologi', ['Sobotta', 'The Selfish Gene', 'Kepunahan Keenam']], ['Fisika', ['A Brief History of Time', 'The Elegant Universe', 'Astrofisika untuk Orang Sibuk']]], "Komputer", ['Machine Learning', 'BCI'])
bo2 = [['Novel', ['Toko Kelontong Namiya', 'Bumi', 'The Little Prince']], ['Komputer', ['Clean Code', 'Modern OS', 'Computer Network', 'DSA', 'Algorithms', 'Machine Learning', 'BCI']], ['Biologi', ['Sobotta', 'The Selfish Gene', 'Kepunahan Keenam']], ['Fisika', ['A Brief History of Time', 'The Elegant Universe', 'Astrofisika untuk Orang Sibuk']]]
a = lambda a,b : True if a == b else False
print(bo1)
print(a(bo1,bo2))
# SEMANGAT ^^